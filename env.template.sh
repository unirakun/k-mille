...
export ACCOUNTANT_EMAIL_SUBJECT_INVOICES="ALAKARTE – FACTURE DE VENTE"
export ACCOUNTANT_EMAIL_SUBJECT_EXPENSES="ALAKARTE – FACTURE D'ACHAT"
# BANK REFERENCE
export BANK_IBAN="FR08 8232 1512 2567 9608 5805 762"
export BANK_BIC=CMCIFRPPXXX
